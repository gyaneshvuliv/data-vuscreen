...
router.get('/analytics/act/watch', controller.vuscreen_watch);
router.get('/analytics/act/pdf', controller.vuscreen_pdf);
router.get('/analytics/act/audio', controller.vuscreen_audio);
router.get('/analytics/act/travel', controller.vuscreen_travel);
router.get('/analytics/act/store', controller.vuscreen_store);
